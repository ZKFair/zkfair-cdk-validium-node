...
import (
	...
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/BridgeA"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/BridgeB"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/BridgeC"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/BridgeD"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/Called"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/Caller"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/ChainCallLevel1"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/ChainCallLevel2"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/ChainCallLevel3"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/ChainCallLevel4"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/Counter"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/Creates"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/Depth"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/ERC20"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/EmitLog"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/Memory"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/OpCallAux"
	"github.com/0xPolygon/cdk-validium-node/test/contracts/bin/Revert2"
