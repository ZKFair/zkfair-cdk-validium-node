...
type ExecutorServiceClient interface {
	...
	GetFlushStatus(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetFlushStatusResponse, error)
}
...
func (c *executorServiceClient) GetFlushStatus(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetFlushStatusResponse, error) {
...
type ExecutorServiceServer interface {
	...
	GetFlushStatus(context.Context, *empty.Empty) (*GetFlushStatusResponse, error)
...
func (UnimplementedExecutorServiceServer) GetFlushStatus(context.Context, *empty.Empty) (*GetFlushStatusResponse, error) {
...
func _ExecutorService_GetFlushStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExecutorServiceServer).GetFlushStatus(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
